                ...
                <div class="col-md-4">
                    ...
                    <div class="single-sidebar">
                        ...
                        <div class="thubmnail-recent">
                            <img src="img/NormalUsers/product-thumb-1.jpg" class="recent-thumb" alt="">
                                    ...
                                    <?php  foreach ($dataProds['cart'] as $key => $product) {?>
                                        <tr class="cart_item">
                                            ...
                                            <td class="product-quantity">
                                                ...
                                                <a href="javascript:;" onclick="dellCart(<?php echo $key?>)">
                                                    <input type="button" class="minus" value="-" >
                                                </a>
                                                    <input type="number" size="4" class="input-text qty text" title="Qty" value="<?php echo isset($this->request->getSession()->read('cartData')['totalquantity']) ? $this->request->getSession()->read('cartData')['totalquantity'] : "0";?>" min="0" step="1">
                                                <a href="javascript:;" onclick="addCart(<?php echo $key?>)">
                                ...
                                <ul class="products">
                                    <li class="product">
                                        <a href="single-product.html">
                                            <img width="325" height="325" alt="T_4_front" class="attachment-shop_catalog wp-post-image" src="img/NormalUsers/product-2.jpg">
                                    ...
                                    <li class="product">
                                        <a href="single-product.html">
                                            <img width="325" height="325" alt="T_4_front" class="attachment-shop_catalog wp-post-image" src="img/NormalUsers/product-4.jpg">
                                            <h3>Ship Your Idea</h3>
                                            <span class="price"><span class="amount">£20.00</span></span>
                                        </a>
