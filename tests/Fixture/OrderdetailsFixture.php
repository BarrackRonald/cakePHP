...
class OrderdetailsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'orderDetail_point' => ['type' => 'integer', 'length' => null, 'unsigned' => false, 'null' => false, 'default' => '0', 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'product_id' => 1,
                'order_id' => 1,
                'created_at' => '2021-09-17 07:37:51',
                'updated_at' => '2021-09-17 07:37:51',
            ],
        ];
        parent::init();
    }
