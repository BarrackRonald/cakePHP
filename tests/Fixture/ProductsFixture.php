...
class ProductsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'amount' => ['type' => 'integer', 'length' => null, 'unsigned' => false, 'null' => false, 'default' => '0', 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'product_point' => ['type' => 'integer', 'length' => null, 'unsigned' => false, 'null' => false, 'default' => '0', 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'status' => 1,
                'category_id' => 1,
                'created_at' => '2021-09-17 07:35:59',
                'updated_at' => '2021-09-17 07:35:59',
            ],
        ];
        parent::init();
    }
