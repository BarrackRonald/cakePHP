			...
			<div class="row">
				<div class="col-12">
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" value="<?= h(trim($dataCategory["category_name"])) ?>" name="category_name">
						<?php if (isset($error)) { ?>
							<i style="color: red;">
					...
					<div class="button_submit">
						<button type="submit" value="<?= $dataCategory["referer"] ?>" name="referer" id="submit" onclick="disable()" class="btn btn-primary btn-default">Submit</button>
