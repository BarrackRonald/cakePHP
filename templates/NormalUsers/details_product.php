...
<div class="single-product-area">
	...
	<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-7">
								<div class="product-inner">
									<h2 class="product-name"><?= h($product['product_name']) ?></h2>
									...
									<div class="product-inner-category">
										<p class="m-t">Category: <a href="<?= $this->Url->build('/view-category/' . $product['category_id'], ['fullBase' => true]) ?>"><?= h($product['Categories']['category_name']) ?></a></p>
									</div>
									<div role="tabpanel">
		...
		<?php if(isset($dataProductByCategory)){ ?>
			<div class="row">
				<div class="col-md-12">
						...
						<div class="product-carousel">
							<?php foreach ($dataProductByCategory as $product) { ?>
								<div class="single-product">
									...
									<h2><a href="<?= $this->Url->build('/details-product/' . $product['id'], ['fullBase' => true]) ?>"><?php echo h($product['product_name']) ?></a></h2>
