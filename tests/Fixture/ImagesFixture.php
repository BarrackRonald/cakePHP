...
class ImagesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'images_ibfk_2' => ['type' => 'foreign', 'columns' => ['product_id'], 'references' => ['products', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'user_id' => 1,
                'product_id' => 1,
                'created_date' => '2021-09-22 02:34:28',
                'updated_date' => '2021-09-22 02:34:28',
            ],
        ];
        parent::init();
    }
